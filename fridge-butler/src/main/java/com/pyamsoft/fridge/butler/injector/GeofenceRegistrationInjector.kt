...
import com.pyamsoft.fridge.butler.runner.geofence.GeofenceRegistrationRunner
import com.pyamsoft.pydroid.ui.Injector
import javax.inject.Inject

class GeofenceRegistrationInjector(context: Context) : BaseInjector(context) {

    @JvmField
    @Inject
    internal var delegate: GeofenceRegistrationRunner? = null
