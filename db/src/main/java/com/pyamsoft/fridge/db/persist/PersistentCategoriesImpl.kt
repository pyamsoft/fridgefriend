...
internal class PersistentCategoriesImpl
@Inject
      ...
      val defaultCategories =
          listOf(
              FridgeCategory.createDefault(
                  "Fruits", loadImage(R.drawable.category_thumbnail_fruits)),
              FridgeCategory.createDefault(
                  "Vegetables", loadImage(R.drawable.category_thumbnail_vegetables)),
              ...
              FridgeCategory.createDefault("Dairy", loadImage(R.drawable.category_thumbnail_dairy)),
              FridgeCategory.createDefault(
                  "Spices", loadImage(R.drawable.category_thumbnail_spices)),
              FridgeCategory.createDefault("Bread", loadImage(R.drawable.category_thumbnail_bread)),
              FridgeCategory.createDefault(
                  "Sweets", loadImage(R.drawable.category_thumbnail_sweets)),
              FridgeCategory.createDefault(
                  "Drinks", loadImage(R.drawable.category_thumbnail_drinks)),
              FridgeCategory.createDefault(
                  "Alcohol", loadImage(R.drawable.category_thumbnail_alcohol)))
