...
interface FridgeCategory : EmptyModel<FridgeCategory> {
  ...
  @CheckResult fun isDefault(): Boolean

  @CheckResult fun thumbnail(): Thumbnail?

  @CheckResult fun invalidateThumbnail(): FridgeCategory

  @CheckResult fun thumbnail(thumbnail: Thumbnail): FridgeCategory
  ...
  companion object {
    ...
    fun createDefault(name: String, thumbnail: Thumbnail?): FridgeCategory {
      return JsonMappableFridgeCategory(
          Id(IdGenerator.generate()), name, currentDate(), thumbnail, isDefault = true)
    }
    ...
    fun create(
      ...
      return JsonMappableFridgeCategory(category.id(), name, createdTime, thumbnail, isDefault)
    }
  }
}
