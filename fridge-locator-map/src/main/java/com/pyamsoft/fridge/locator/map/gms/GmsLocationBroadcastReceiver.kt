...
abstract class GmsLocationBroadcastReceiver protected constructor() : LocationBroadcastReceiver() {

  final override fun onLocationEvent(
    context: Context,
    intent: Intent
  ) {
    try {
  ...
  protected abstract fun onLocationEvent(intent: Intent)
