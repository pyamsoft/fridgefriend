...
@Subcomponent(modules = [CreateEntryComponent.ViewModelModule::class, ThemeProviderModule::class, TooltipModule::class])
internal interface CreateEntryComponent {
    ...
    abstract class ViewModelModule {
        ...
        internal abstract fun entryViewModel(viewModel: CreateEntryViewModel): UiViewModel<*, *, *>
    }
}
