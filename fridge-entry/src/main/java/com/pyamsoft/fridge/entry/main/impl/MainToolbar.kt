...
import com.pyamsoft.fridge.entry.main.impl.MainToolbar.Callback
...
internal class MainToolbar @Inject internal constructor(
  ...
  override val layout: Int = R.layout.colored_toolbar

  override val layoutRoot by lazyView<Toolbar>(R.id.colored_toolbar)
