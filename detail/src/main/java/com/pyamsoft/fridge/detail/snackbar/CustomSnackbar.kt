...
private constructor(
  ...
  companion object {
    ...
    @JvmField
    val Break = Snackbreak.create { view, message, duration -> create(view, message, duration) }
    ...
    fun create(view: View, message: CharSequence, duration: Int): CustomSnackbar {
      ...
      return CustomSnackbar(parent, binding).setText(message).setDuration(duration)
    }
  }
}
